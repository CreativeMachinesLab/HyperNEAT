...
namespace NEAT
{
    ...
    protected:
		...
		int nodesAdded;
		int linksAdded;
		int linkWeightsMutated;
		int linkWeightsNotMutated;
		int linksDemolished;
...
/*
			inline void setOrigFitness(double _origFitness)
			{
				origFitness = _origFitness;
			}
*/
void setOrigFitness(double _origFitness);

			inline void setNumFilled(double _numFilled)
			{
				numFilled = _numFilled;
			}
      ...
      /////////////// GET FITNESS FUNCTIONS
			...
			inline double getNumFilled()        const { return numFilled; }
			inline bool   getMutatedAtBirth() 	const { return mutatedAtBirth; }
			inline int    getNodesAdded() 		const { return nodesAdded; }
			inline int    getLinksAdded() 		const { return linksAdded; }
			inline int    getLinkWeightsMutated() const { return linkWeightsMutated; }
			inline int    getLinkWeightsNotMutated() const { return linkWeightsNotMutated; }
			inline int    getLinksDemolished() 	const { return linksDemolished; }
			inline double getParent1Fitness() 	const { return parent1Fitness; }
			inline double getParent2Fitness() 	const { return parent2Fitness; }
			inline string getParent1md5() 		const { return parent1md5; }
			inline string getParent2md5() 		const { return parent2md5; }
      ...
      /////////////// SET FITNESS FUNCTIONS
			...
			inline void setParent1md5(string value)	{ parent1md5 = value;}
			inline void setParent2md5(string value)	{ parent2md5 = value;}
